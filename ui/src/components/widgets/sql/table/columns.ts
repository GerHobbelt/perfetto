...
export class TimestampColumn implements TableColumn {
  constructor(public readonly column: SqlColumn, public readonly trace: Trace) {}
...
export class DurationColumn implements TableColumn {
  constructor(public column: SqlColumn, private readonly trace: Trace) {}
  ...
  listDerivedColumns() {
    ...
    return async () =>
      new Map<string, TableColumn>([
        ['ts', new TimestampColumn(this.getChildColumn('ts'), this.trace)],
        ['dur', new DurationColumn(this.getChildColumn('dur'), this.trace)],
        ['name', new StandardColumn(this.getChildColumn('name'))],
        ['parent_id', new SliceIdColumn(this.getChildColumn('parent_id'), this.trace)],
      ]);
  }
...
export class SchedIdColumn implements TableColumn {
  constructor(public readonly column: SqlColumn, private readonly trace: Trace) {}
  ...
  listDerivedColumns() {
    ...
    return async () =>
      new Map<string, TableColumn>([
        ...
        ['name', new StandardColumn(this.getChildColumn('name'))],
        ['start_ts', new TimestampColumn(this.getChildColumn('start_ts'), this.trace)],
        ['end_ts', new TimestampColumn(this.getChildColumn('end_ts'), this.trace)],
        ['upid', new ProcessIdColumn(this.getChildColumn('upid'), this.trace)],
        [
          'is_main_thread',
  ...
  listDerivedColumns() {
    ...
    return async () =>
      new Map<string, TableColumn>([
        ...
        [
          'parent_upid',
          new ProcessIdColumn(this.getChildColumn('parent_upid'), this.trace),
        ],
        [
          'is_main_thread',
          new StandardColumn(this.getChildColumn('is_main_thread')),
