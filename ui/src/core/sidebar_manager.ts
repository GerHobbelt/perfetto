...
export class SidebarManagerImpl implements SidebarManager {
  ...
  constructor(
    args: {
      ...
      disabled?: boolean;
      hidden?: boolean;
      parentMenuItems?: Registry<SidebarMenuItemInternal>;
    } = {id: 'root'},
  ) {
    this.id = args.id;
    ...
    this.menuItems =
      args.parentMenuItems?.createChild(args.id) ??
      new Registry<SidebarMenuItemInternal>((m) => m.id);
  }
