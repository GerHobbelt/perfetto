...
export default class implements PerfettoPlugin {
  ...
  async onTraceLoad(ctx: Trace) {
    sqlTableRegistry['slice'] = getSliceTable(ctx);
    ...
    sqlTableRegistry['thread'] = getThreadTable(ctx);
    ctx.commands.registerCommand({
    ...
    sqlTableRegistry['process'] = getThreadTable(ctx);
    ctx.commands.registerCommand({
    ...
    sqlTableRegistry['sched'] = getSchedTable(ctx);
    ctx.commands.registerCommand({
    ...
    sqlTableRegistry['thread_state'] = getThreadStateTable(ctx);
    ctx.commands.registerCommand({
    ...
    sqlTableRegistry['android_logs'] = getAndroidLogsTable(ctx);
    ctx.commands.registerCommand({
